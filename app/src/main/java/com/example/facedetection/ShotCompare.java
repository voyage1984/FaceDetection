...
public class ShotCompare extends Activity implements CameraBridgeViewBase.CvCameraViewListener2, View.OnClickListener  {

    private int mCameraIndexCount;
    private Button mCameraChange,mShot;

    public native void rotateImage(long addr);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shot_compare);
        ...
        mCameraChange = findViewById(R.id.shotChangeCamera);
        mCameraChange.setOnClickListener(this);
        mOpenCvCameraView.setCameraIndex(mCameraIndexCount);

        mShot = findViewById(R.id.shotCompareCamera);
